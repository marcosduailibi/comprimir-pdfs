...
export const TOOLS = [
  ...
  },
  {
    ...
    description: "Fotografe documentos e gere um PDF.",
    tooltip: "Fotografe documentos pela câmera e gere um PDF localmente, sem enviar nada.",
    categoryIds: ["ocr"], aliases: ["camera", "foto", "escanear", "scan", "digitalizar"],
    inputExtensions: [], outputExtensions: ["pdf"],
    route: "#", icon: "📷", status: "coming-soon", supportsBatch: false, isLocalFirst: true,
    requiresCamera: true, notes: [],
  },
  {
